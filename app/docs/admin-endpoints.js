 ...
 *     description: Get paginated list of all patients (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *     description: Get detailed information about a specific patient (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     description: Update patient information (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *   patch:
 *     tags: [Admins]
 *     summary: Toggle patient status
 *     description: Update patient status (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     description: Get paginated list of all service categories (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *     description: Get detailed information about a specific service category (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: Service category details retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               allOf:
...
/**
 * @swagger
 * /api/admin/service-categories/{id}/toggle-status:
 *   patch:
 *     tags: [Admins]
 *     summary: Toggle service category status
 *     description: Activate or deactivate a service category (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *               $ref: '#/components/schemas/Success'
 *       400:
 *         description: Cannot delete category with existing service offerings
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 ...
 *     description: Get paginated list of all services with statistics (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *     description: Get all services pending approval (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *   patch:
 *     tags: [Admins]
 *     summary: Approve or reject service
 *     description: Approve or reject a service offering (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
